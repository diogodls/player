  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      BEGIN
        ...
        FROM (VALUES
          ('70000000-0000-0000-0000-000000000001'::uuid, 'LEO ELIAS', 'Pivo'),
          ('70000000-0000-0000-0000-000000000002'::uuid, 'EVERTON', 'Ala'),
          ('70000000-0000-0000-0000-000000000003'::uuid, 'SENNA', 'Ala'),
          ('70000000-0000-0000-0000-000000000004'::uuid, 'PET', 'Fixo')
    ...
    await queryRunner.query(`
      WITH quantidades(jogador_id, jogador_ordem, sigla, quantidade) AS (VALUES
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'Gol TO', 1),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'Gol GL', 1),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'GS TO', 2),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'GM', 1),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'CC', 4),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'PP', 2),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'FD', 3),
        ('70000000-0000-0000-0000-000000000001'::uuid, 1, 'DIA', 4),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'Gol GL', 1),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'GS OO', 2),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'GS BP', 1),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'ASS', 1),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'CC', 24),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'PP', 8),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'FD', 4),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'RB', 2),
        ('70000000-0000-0000-0000-000000000002'::uuid, 2, 'DIA', 2),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'Gol TO', 1),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'GS TO', 2),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'ASS', 1),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'CC', 10),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'PP', 9),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'FD', 2),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'RB', 1),
        ('70000000-0000-0000-0000-000000000003'::uuid, 3, 'DIA', 5),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'GS TO', 1),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'GS OO', 2),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'GS BP', 1),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'CC', 12),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'PP', 2),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'FD', 7),
        ('70000000-0000-0000-0000-000000000004'::uuid, 4, 'DIA', 7)
      ), eventos AS (
    ...
    await queryRunner.query(`
      ...
      FROM (VALUES
        ('70000000-0000-0000-0000-000000000101'::uuid, '70000000-0000-0000-0000-000000000003'::uuid, 'ENTROU', 0),
        ('70000000-0000-0000-0000-000000000102'::uuid, '70000000-0000-0000-0000-000000000003'::uuid, 'SAIU', 851),
        ('70000000-0000-0000-0000-000000000103'::uuid, '70000000-0000-0000-0000-000000000002'::uuid, 'ENTROU', 0),
        ('70000000-0000-0000-0000-000000000104'::uuid, '70000000-0000-0000-0000-000000000002'::uuid, 'SAIU', 1561),
        ('70000000-0000-0000-0000-000000000105'::uuid, '70000000-0000-0000-0000-000000000004'::uuid, 'ENTROU', 0),
        ('70000000-0000-0000-0000-000000000106'::uuid, '70000000-0000-0000-0000-000000000004'::uuid, 'SAIU', 1090),
        ('70000000-0000-0000-0000-000000000107'::uuid, '70000000-0000-0000-0000-000000000001'::uuid, 'ENTROU', 0),
        ('70000000-0000-0000-0000-000000000108'::uuid, '70000000-0000-0000-0000-000000000001'::uuid, 'SAIU', 1183)
